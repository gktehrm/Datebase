    ...
    <div className="h-full flex flex-col">
      ...
      <div className="mb-6">
        ...
        <input
          ...
          className="w-full px-6 py-3 rounded-xl font-semibold transition-all bg-white text-slate-700 hover:bg-slate-50 border border-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500/50"
        />
      </div>

      <div className="grid grid-cols-4 gap-4 mb-6">
        <StatCard title="전체 로그 수" value={stats.totalLogs} icon={TrendingUp} color="#3b82f6" />
        <StatCard title="위험 로그" value={stats.harmfulCount} icon={AlertTriangle} color="#ef4444" />
        <StatCard title="승인 필요" value={stats.approvalRequiredCount} icon={Shield} color="#f59e0b" />
        <StatCard title="승인됨" value={stats.approvedCount} icon={Shield} color="#14b8a6" />
      </div>
